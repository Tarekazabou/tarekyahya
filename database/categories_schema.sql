-- =====================================================
-- CATEGORIES & FACETED FILTERING SCHEMA
...
CREATE TABLE IF NOT EXISTS categories (
    ...
    product_count INT DEFAULT 0, -- Denormalized for performance
...
CREATE TABLE IF NOT EXISTS product_categories (
    ...
    is_primary BOOLEAN DEFAULT false, -- Main category for the product
    created_at TIMESTAMP DEFAULT NOW(),
...
-- =====================================================
-- 3. ATTRIBUTES TABLE (for faceted filtering)
-- =====================================================
CREATE TABLE IF NOT EXISTS attributes (
    id SERIAL PRIMARY KEY,
    name VARCHAR(100) NOT NULL,
    slug VARCHAR(100) UNIQUE NOT NULL,
    display_type VARCHAR(50) DEFAULT 'checkbox', -- checkbox, color, size, range
    sort_order INT DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS attribute_values (
    ...
    color_code VARCHAR(20), -- For color swatches (#FF0000)
    sort_order INT DEFAULT 0,
    is_active BOOLEAN DEFAULT true,
...
-- =====================================================
-- 5. PRODUCT_ATTRIBUTE_VALUES (Product <-> Attribute pivot)
-- =====================================================
...
-- =====================================================
-- 6. ALTER PRODUCTS TABLE - Add new columns
-- =====================================================
ALTER TABLE products 
ADD COLUMN IF NOT EXISTS price DECIMAL(10,2),
ADD COLUMN IF NOT EXISTS price_original DECIMAL(10,2), -- For showing discounts
ADD COLUMN IF NOT EXISTS sku VARCHAR(50),
ADD COLUMN IF NOT EXISTS brand VARCHAR(100),
ADD COLUMN IF NOT EXISTS color VARCHAR(50),
ADD COLUMN IF NOT EXISTS size_type VARCHAR(50), -- XS, S, M, L, XL or numeric
ADD COLUMN IF NOT EXISTS material VARCHAR(100),
ADD COLUMN IF NOT EXISTS gender VARCHAR(20), -- homme, femme, mixte, enfant
ADD COLUMN IF NOT EXISTS is_new BOOLEAN DEFAULT false,
ADD COLUMN IF NOT EXISTS is_on_sale BOOLEAN DEFAULT false,
ADD COLUMN IF NOT EXISTS stock_status VARCHAR(20) DEFAULT 'in_stock', -- in_stock, low_stock, out_of_stock
...
-- =====================================================
-- 8. VIEWS FOR FACETED SEARCH
-- =====================================================

-- View: Products with all their data joined
...
SELECT 
    ...
    p.stock_status,
    p.published_at,
    -- Aggregate category IDs and names
...
-- =====================================================
-- 9. RPC FUNCTION: Get Products with Faceted Filtering
-- =====================================================
CREATE OR REPLACE FUNCTION get_products_faceted(
    ...
    p_sort_by VARCHAR DEFAULT 'newest', -- newest, price_asc, price_desc, name, featured
...
BEGIN
    ...
    WITH filtered_products AS (
        ...
        WHERE 1=1
            ...
            -- Gender filter (support both new column and legacy category)
...
-- =====================================================
-- 10. RPC FUNCTION: Get Categories Tree
-- =====================================================
...
-- =====================================================
-- 11. TRIGGER: Update category product counts
-- =====================================================
...
-- =====================================================
-- 12. SEED DATA: Sample Categories
-- =====================================================
...
-- =====================================================
-- 13. SEED DATA: Sample Attributes
-- =====================================================
...
-- =====================================================
-- MIGRATION HELPER: Link existing products to categories
-- =====================================================
-- This maps the legacy 'category' column to the new categories table
...
-- Update gender column from legacy category
UPDATE products
SET gender = category
WHERE category IN ('homme', 'femme') AND gender IS NULL;

COMMENT ON TABLE categories IS 'Hierarchical product categories for faceted navigation';
COMMENT ON TABLE attributes IS 'Product attributes for faceted filtering (color, size, etc.)';
COMMENT ON FUNCTION get_products_faceted IS 'Main RPC for fetching products with filters and facet counts';
